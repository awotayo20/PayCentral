  ...
  return (
    <>
        ...
        <div className='w-[660px] text-[24px] mx-auto'>
            <h2 className='text-[24px] font-[500]'>Connect with our friendly community exploring and sharing payment innovations.</h2>
            <p className='text-[16px] font-[500] mt-4'>Already have an account? <span className='text-[#312ECB] cursor-pointer'>Login</span></p>
                ...
                <form action="">
                    <div className='flex flex-col gap-[30px] mb-[32px]'>
                        ...
                        <div className='flex items-center gap-2'>
                            <input type="checkbox" name="" id="" className='w-[24px] h-[24px]'/>
                            <p className='text-[16px] font-[400]'>I agree to the <span className='font-[500] underline cursor-pointer'>Terms Of Service</span> and <span className=' cursor-pointer font-[500] underline'>Privacy Policy</span> </p>
                        </div>
                    </div>

                    <button className='w-full p-[8px] bg-black text-white'>Join PayCentral</button>
                </form>
            </div>
        </div>
        </div>
